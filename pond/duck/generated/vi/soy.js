...
Pond.Duck.soy.start = function(opt_data, opt_ignored, opt_ijData) {
  return '' + Pond.Duck.soy.messages(null, null, opt_ijData) + BlocklyGames.soy.headerBar({appName: '\u0110\u1EA1i chi\u1EBFn l\u1EADp tr\u00ECnh', levelLinkSuffix: '', hasLinkButton: false, hasHelpButton: false, farLeftHtml: ''}, null, opt_ijData) + Pond.soy.visualization(null, null, opt_ijData) + '<div id="tabarea"><div id="editorBar" class="tab-bar"><div><select id="avatar-select"></select></div><div class="tab tab-selected">Kh\u1ED1i</div><div class="tab">JavaScript</div></div><div class="tab-bar-clear"></div><div id="blockly"></div><div id="editor"></div></div>' + Pond.Duck.soy.toolbox(null, null, opt_ijData) + BlocklyGames.soy.dialog(null, null, opt_ijData);
};
if (goog.DEBUG) {
